                  ...
                  Obx(
                    () => SettingsSwitch(
                      onChanged: (bool val) async {
                        SettingsSvc.settings.enableClipboardSync.value = val;
                        await SettingsSvc.settings.saveOneAsync('enableClipboardSync');
                        if (val) {
                      ...
                      initialVal: SettingsSvc.settings.enableClipboardSync.value,
